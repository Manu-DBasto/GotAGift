...
@section('content')
    ...
    @endif
    <div class="container">
        <h1 class="mb-4 text-center">Premios</h1>
                    ...
                    <div class="card h-100 shadow-sm">
                        <a href="#" class="text-decoration-none text-reset">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text fw-bold">Costo: {{ $producto->precio_puntos }} puntos</p>
                        ...
                        <div class="card-footer bg-transparent border-top-0 text-center">
                            <form action="{{ route('canjear.premio') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-warning text-light">Canjear
                                </button>
                            </form>
                        </div>
                    </div>
