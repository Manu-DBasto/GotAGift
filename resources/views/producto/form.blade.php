    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="form-group mb-2 mb20 col">
                ...
                <input type="text" name="precio_puntos"
                    class="form-control @error('precio_puntos') is-invalid @enderror"
        ...
        <div class="row">
            <div class="form-group mb-2 col">
                <label for="regalo" class="form-label">{{ __('Es premio?') }}</label>
                <select name="regalo" id="regalo" class="form-control @error('regalo') is-invalid @enderror">
                    <option value="1" {{ old('regalo', $producto?->regalo) == 1 ? 'selected' : '' }}>Activo
                    </option>
                    <option value="0" {{ old('regalo', $producto?->regalo) == 0 ? 'selected' : '' }}>Inactivo
                    </option>
                </select>
            ...
            <div class="form-group mb-2 mb20 col">
                <label for="activo" class="form-label">{{ __('Visibilidad') }}</label>
                <select name="activo" id="activo" class="form-control @error('activo') is-invalid @enderror">
                    <option value="1" {{ old('activo', $producto?->activo) == 1 ? 'selected' : '' }}>Activo
                    </option>
                    <option value="0" {{ old('activo', $producto?->activo) == 0 ? 'selected' : '' }}>Inactivo
                    </option>
                </select>
