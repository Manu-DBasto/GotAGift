    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 wrapper">
                <div class="card rounded-5 formContainer">

                    <div class="card-body">
                        <h3 class="text-center pb-2 fw-bold">Registro</h3>
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="phone"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Número telefónico') }}</label>
                                ...
                                <div class="col-md-6">
                                    <select id="estado" name="estado"
                                        ...
                                        <option value="Aguascalientes"
                                            {{ old('estado') == 'Aguascalientes' ? 'selected' : '' }}>Aguascalientes
                                        </option>
                                        <option value="Baja California"
                                            {{ old('estado') == 'Baja California' ? 'selected' : '' }}>Baja California
                                        </option>
                                        <option value="Baja California Sur"
                                            {{ old('estado') == 'Baja California Sur' ? 'selected' : '' }}>Baja California
                                            Sur</option>
                                        <option value="Campeche" {{ old('estado') == 'Campeche' ? 'selected' : '' }}>
                                            Campeche
                                        </option>
                                        ...
                                        <option value="Ciudad de México"
                                            {{ old('estado') == 'Ciudad de México' ? 'selected' : '' }}>Ciudad de México
                                        </option>
                                        <option value="Coahuila" {{ old('estado') == 'Coahuila' ? 'selected' : '' }}>
                                            Coahuila
                                        </option>
                                        ...
                                        <option value="Estado de México"
                                            {{ old('estado') == 'Estado de México' ? 'selected' : '' }}>Estado de México
                                        </option>
                                        <option value="Guanajuato" {{ old('estado') == 'Guanajuato' ? 'selected' : '' }}>
                                            Guanajuato</option>
                                        <option value="Guerrero" {{ old('estado') == 'Guerrero' ? 'selected' : '' }}>
                                            Guerrero
                                        </option>
                                        ...
                                        <option value="Nuevo León" {{ old('estado') == 'Nuevo León' ? 'selected' : '' }}>
                                            Nuevo
                                            León</option>
                                        ...
                                        <option value="Quintana Roo"
                                            {{ old('estado') == 'Quintana Roo' ? 'selected' : '' }}>
                                            Quintana Roo</option>
                                        <option value="San Luis Potosí"
                                            {{ old('estado') == 'San Luis Potosí' ? 'selected' : '' }}>San Luis Potosí
                                        </option>
                                        ...
                                        <option value="Tamaulipas" {{ old('estado') == 'Tamaulipas' ? 'selected' : '' }}>
                                            Tamaulipas</option>
                                        <option value="Tlaxcala" {{ old('estado') == 'Tlaxcala' ? 'selected' : '' }}>
                                            Tlaxcala
                                        </option>
                                        <option value="Veracruz" {{ old('estado') == 'Veracruz' ? 'selected' : '' }}>
                                            Veracruz
                                        </option>
